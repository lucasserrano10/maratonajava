...
public class NumberFormatTest03 {
    public static void main(String[] args) {
        ...
        nfmt[0] = NumberFormat.getInstance(localeIT);
        nfmt[1] = NumberFormat.getInstance(localePT);
        nfmt[2] = NumberFormat.getInstance(localeJP);
        nfmt[3] = NumberFormat.getInstance(localeUK);
